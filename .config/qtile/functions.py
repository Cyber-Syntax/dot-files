...
#### HDMI-0 right monitor   :   screen_affinity=1, group 3 ## Detached
#### DP-0   left monitor    :   screen_affinity=2, group 1 ## Detached
# ./old variables
...
def cycle_groups(qtile):
    ...
    next_group_index = (current_group_index + 1) % len(qtile.groups)
...
#     if len(qtile.{value for value in iterable}reens) == 1:
